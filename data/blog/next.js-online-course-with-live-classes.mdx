---
title: 'Next js course with live classes'
tags: ['online course','next js','Microservices','live classes']
draft: false
...
Duration of the course is from 4 to 6 weeks. Each of the below topics is covered in live classes. Every problem students face is resolved on the spot.

1. Why use Nextjs and advantages of Next js over React js.
