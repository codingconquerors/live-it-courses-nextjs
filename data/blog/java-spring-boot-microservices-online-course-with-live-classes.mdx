...
date: '2022-1-23'
tags: ['online course', 'java', 'spring Boot', 'Microservices', 'live classes']
draft: false
...
This course focus on backend part of an enterprise level project. Course duration is from 4 to 6 weeks. Following topics are covered in live sessions:
...
14. Call one microservice to another microservice using synchronous and asynchronous methods.
